...
#define E1000_REG_ECTRL 	0x00018
...
#define E1000_REG_WAKEUP_CTRL   0x05800

/** wake up filter control **/
#define E1000_REG_WAKEUP_FILTER  0x05808

#define E1000_REG_RDTR  0x02820

#define E1000_REG_ITR 0x000C4 

#define E1000_REG_RADV 0x0282

#define E1000_REG_RSRPD 0x02c00

#define E1000_REG_IMCR 0x000D8 
...
/**
 * @name Wakeup Control Register Bits.
 * @{
 */
 #define E1000_REG_WAKEUP_CTRL_APME (1 << 0)
...
/**
 * @name Wakeup Register Bits.
 * @{
 */
/*exact match to an address in the filter table **/
#define E1000_REG_WAKEUP_FILTER_EX  (1 << 2)

/** multicast packet received */
#define E1000_REG_WAKEUP_FILTER_MC  (1 << 3)

/** broadcase packet received */
#define E1000_REG_WAKEUP_FILTER_BC  (1 << 4)

/** arp packet received */
#define E1000_REG_WAKEUP_FILTER_ARP  (1 << 5)
/**
 * @}
 */
...
#define E1000_REG_CTRL_SPEED_SEL  0x300 //bits 9 & 10

/*force speed sleect */
#define E1000_REG_CTRL_FRCSPEED   (1 << 11)

/*set the force duplex bit */
#define E1000_REG_CTRL_FRCDPLX		(1 <<12)

/*set speed 1000 Mb/s */
#define E1000_REG_CTRL_SPEED_1000 (1 << 9) | (0 << 8)

/*set speed 100 Mb/s */
#define E1000_REG_CTRL_SPEED_100 (0 << 9) | (1 << 8) 

/*set speed 10 Mb/s */
#define E1000_REG_CTRL_SPEED_10 (0 << 9) | (0 << 8)
...
/**
 * @name Extended Control Register Bits.
 * @{
 */

/* initiate an auto speed detection check **/
/* results are reported in status bits asd 6 & 7 */
#define E1000_REG_ECTRL_ASDCHK  (1 << 12)

#define E1000_REG_ECTRL_PHY_PWRMGT  (0 << 20)
...
/* read sequence error */
#define E1000_REG_ICR_RXSEQ (1 << 3)

/* mininium treshold for num of avil descriptors reached */
#define E1000_REG_ICR_RXDMT  (1 << 4)
...
/* interrupt from the phy */
#define E1000_REG_ICR_PHYINT (1 << 12)

/*small packet received */
#define E1000_REG_ICR_SRPD (1 << 16)

/*stupid fifo queue */
#define E1000_REG_ICR_TXPARERR (1 << 21)
#define E1000_REG_ICR_RXPARERR (1 << 20)
#define E1000_REG_ICR_TXPARERR1 (1 << 24)
#define E1000_REG_ICR_RXPARERR1 (1 << 25)
/**
 * @}
 */
...
#define E1000_REG_IMS_SRPD (1 << 16)
...
#define E1000_REG_RCTL_BSIZE	(1 << 12)
...
/* Collision distance */
#define E1000_REG_TCTL_COLD	(0x40 << 12)

/*collision threshold */
#define E1000_REG_TCTL_CT	(0x10 << 4)
/**
 * @}
 */
...
/* receive address filter type e.g. source or dest */
#define E1000_REG_RAH_ASEL_HI  (0 << 17)
#define E1000_REG_RAH_ASEL_LO (0 << 16 )  /* O DEST 1 SOURCE */
